...
use_route.post('/activationcode', useController.ActivationCode)
use_route.post('/activated', useController.Activated)
use_route.post('/login', useController.login)
use_route.post('/profile', useController.getProfile)
use_route.post('/store', useController.store)
use_route.post('/storeData', useController.storeData)
...
use_route.post('/getcategories', useController.getcategories)
use_route.post('/deletecategory', useController.deletecategory)
use_route.post('/addproduct', useController.addproduct)
use_route.post('/getproducts', useController.getproducts) 
